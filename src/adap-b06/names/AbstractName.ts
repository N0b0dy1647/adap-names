...
export abstract class AbstractName implements Name {
    ...
    public getHashCode(): number {
        ...
        hash = hash ^ this.delimiter.charCodeAt(0);
    ...
    protected checkRangeAndTypeErrEqual(i: number, c: string): void {
        IllegalArgumentException.assert(
            c !== null && c !== undefined,
            "Component cannot be null or undefined"
        );
    ...
    protected checkRangeAndTypeErr(i: number, c: string): void {
        IllegalArgumentException.assert(
            c !== null && c !== undefined,
            "Component cannot be null or undefined"
        );
    ...
    protected checkRangeErrEqual(i: number): void {
        IllegalArgumentException.assert(
            i >= 0 && i < this.getNoComponents(),
            `Index ${i} out of bounds for Name with ${this.getNoComponents()} components`
        );
    ...
    protected checkTypeErr(c: string): void {
        IllegalArgumentException.assert(
            c !== null && c !== undefined,
            "Component cannot be null or undefined"
        );
